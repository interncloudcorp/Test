...
@InputType()
class ActivityCreateNestedManyWithoutCustomersInput {
...
export { ActivityCreateNestedManyWithoutCustomersInput as ActivityCreateNestedManyWithoutCustomersInput };
